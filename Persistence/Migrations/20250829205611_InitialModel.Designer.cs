...
namespace Persistence.Migrations
{
    ...
    [Migration("20250829205611_InitialModel")]
            ...
            modelBuilder.Entity("Persistence.Models.BBK", b =>
                {
                    ...
                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("ix_bb_ks_code");

                    b.ToTable("bb_ks", (string)null);
                });
            ...
            modelBuilder.Entity("Persistence.Models.UDK", b =>
                {
                    ...
                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("ix_ud_ks_code");

                    b.ToTable("ud_ks", (string)null);
                });
            ...
            modelBuilder.Entity("Persistence.Models.Book", b =>
                {
                    b.HasOne("Persistence.Models.BBK", "BBK")
                        .WithMany("Books")
                        .HasForeignKey("BBKId")
                        .HasConstraintName("fk_books_bb_ks_bbk_id");
                    ...
                    b.HasOne("Persistence.Models.UDK", "UDK")
                        .WithMany("Books")
                        .HasForeignKey("UDKId")
                        .HasConstraintName("fk_books_ud_ks_udk_id");
